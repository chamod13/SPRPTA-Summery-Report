...
// Database Configuration (Unused for now - Commented out to prevent errors)
// const pool = new Pool({
//   user: 'postgres',
//   host: 'localhost',
//   database: 'sprpta_db',
...
app.post('/api/generate-report', (req, res) => {
  ...
  try {
    ...
    // --- USE HELPER ---
    const { sortedRoutes, sortedOffenses, offenseStats, totalFines, totalIncidents } =
      analyzeData(data)
    ...
    doc
      ...
      .fontSize(28)
      .font('Helvetica-Bold')
      .text('SPRPTA', 160, 35, { characterSpacing: 2 })
    doc
      .fillColor('white')
      .fontSize(10)
      .font('Helvetica-Bold')
      .text('SUMMARY REPORT AUTOMATION SYSTEM', 160, 65, { characterSpacing: 1.5 })
    doc
      .fillColor('#cccccc')
      .fontSize(9)
      .font('Helvetica')
      .text('Southern Provincial Road Passenger Transport Authority', 160, 80, {
    ...
    doc.text(`Time: ${new Date().toLocaleTimeString()}`, 400, 65, { width: 150, align: 'right' })
    ...
    doc
      ...
      .fontSize(20)
      .font('Helvetica-Bold')
      .text('Executive Analysis', 50, doc.y, { align: 'left', underline: true })
    doc.moveDown(1)
    ...
    const summaryItems = [
      ...
      {
        label: 'Most Critical Route:',
        value: `Route ${sortedRoutes[0] ? sortedRoutes[0][0] : 'N/A'}`,
      },
    ...
    summaryItems.forEach((item) => {
      ...
      doc
        ...
        .fontSize(12)
        .font('Helvetica-Bold')
        .text(item.label, 65, summaryY - 2)
      doc
        .fillColor('#555')
        .fontSize(12)
        .font('Helvetica')
        .text(item.value, 230, summaryY - 2)
      summaryY += 25
    })
    ...
    doc
      ...
      .fontSize(24)
      .font('Helvetica-Bold')
      .text(totalIncidents, 50, kpiTop + 15, { width: 240, align: 'center' })
    doc
      .fillColor('#666')
      .fontSize(10)
      .font('Helvetica')
      .text('Total Recorded Incidents', 50, kpiTop + 45, { width: 240, align: 'center' })
    ...
    doc
      ...
      .fontSize(24)
      .font('Helvetica-Bold')
      .text(`LKR ${totalFines.toLocaleString()}`, 305, kpiTop + 15, { width: 240, align: 'center' })
    doc
      .fillColor('#666')
      .fontSize(10)
      .font('Helvetica')
      .text('Total Revenue from Fines', 305, kpiTop + 45, { width: 240, align: 'center' })
    ...
    doc
      ...
      .fontSize(16)
      .font('Helvetica-Bold')
      .text('Top 5 High-Risk Routes', 50, doc.y)
    doc.moveDown(1)
    ...
    sortedRoutes.forEach((item, index) => {
      ...
      doc
        ...
        .fontSize(11)
        .font('Helvetica')
        .text(`Route ${route}`, 50, chartY + 5, { width: 60, align: 'right' })
    ...
    sortedOffenses.slice(0, 6).forEach((item, index) => {
      ...
      doc
        .fillColor('#333')
        .fontSize(10)
        .text(`${item[0]} (${Math.round(percentage * 100)}%)`, legendX + 25, legendY + 3)
      legendY += 25
